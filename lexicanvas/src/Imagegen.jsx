...
const Imagegen = () => {
  return (
    <>
      <div className="relative w-[95%] h-[500px] rounded-3xl my-15 ml-auto mr-auto sm:w-[89vw] ">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          ...
          <div className="relative w-[85%] my-7.5">
            <span className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-400 md:left-[2%] lg:left-[20%]">
              <IoMdSearch size={20} />
            </span>
            <input
              type="text"
              placeholder="Describe"
              className="bg-[#162238] w-[105%] h-13 rounded-2xl text-white px-10 pr-20 ml-auto mr-auto  lg:w-[65%] lg:ml-[19%] "
            />
